                            ...
                            <table class="table table-hover tablesorter " id="">
                                ...
                                <tbody>
                                    ...
                                    while (list($cat_id, $cat_title) = mysqli_fetch_array($result)) {
                                        ...
                                        $i++;
                                        echo "<tr><td>$cat_id</td><td>$cat_title</td><td>$count</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
                        ...
                        <div class="table-responsive ps">
                            <table class="table table-hover tablesorter " id="">
                                ...
                                <tbody>
                                    ...
                                    while (list($subscriber_id, $subscriber_email) = mysqli_fetch_array($result)) {
                                        echo "<tr><td>$subscriber_id</td><td>$subscriber_email</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
