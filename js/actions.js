$(document).ready(function(){
    ...
    // cat() is a function fetching category record from the database whenever the page is loaded
    function cat(){
        $.ajax({
            url    :    "action.php",
            method :    "POST",
    ...
    // product() is a function fetching product record from the database whenever the page is loaded
    function product(){
        $.ajax({
            url    :    "action.php",
            method :    "POST",
    ...
    /* When the page is loaded successfully, there is a list of categories. 
       When the user clicks on a category, we will get the category ID and 
       according to the ID, we will show products
    */
